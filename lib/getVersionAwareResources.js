...
function getEnvironmentInfo() {
  // Try to get version from ppro - may be different API
  let premiereVersion;

  // Check different possible ways to get version
  ...
  const uxpVersion = typeof versions !== "undefined" ? versions.uxp : "unknown"; // Global UXP API
